...
<div class="container mx-auto p-6">
  ...
  <a href="{{ route('admin.users.create') }}" class="mb-4 inline-block px-4 py-2 bg-green-500 text-white rounded">Nuevo Vendedor</a>
  <table class="min-w-full bg-white shadow rounded">
    <thead class="bg-gray-100"><tr>
      <th class="px-4 py-2">Nombre</th><th class="px-4 py-2">Email</th><th class="px-4 py-2">Acciones</th>
    </tr></thead>
    <tbody>
      @forelse($users as $u)
      ...
      @empty
      <tr><td colspan="3" class="px-4 py-4 text-center text-gray-600">No hay vendedores.</td></tr>
      @endforelse
    </tbody>
  </table>
</div>
